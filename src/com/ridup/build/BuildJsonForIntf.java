 ...
 * @author ridup
 * @version V3.0
 * @since 3.0.3 2021-05-26 09:50
 */
public class BuildJsonForIntf {
    ...
    public ArrayList<YapiApiDTO> actionPerformedList(AnActionEvent e, String attachUpload, String returnClass) {
        ...
        // 判断是否是接口
        if(selectedClass==null || !JvmClassKind.INTERFACE.equals(selectedClass.getClassKind())){
    ...
    public static YapiApiDTO actionPerformed(PsiClass selectedClass, PsiMethod psiMethodTarget, Project project, PsiFile psiFile, String attachUpload, String returnClass) {
        ...
        stringBuilder.append("Bean名称:").append(selectedClass.getName()).append("\n");
        ...
        yapiApiDTO.setBasePath("/"+selectedClass.getName());
     ...
     * @date: 2019/2/19
     */
    public static void getRequest(Project project, YapiApiDTO yapiApiDTO, PsiMethod psiMethodTarget) throws
        JSONException {
